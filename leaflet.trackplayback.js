...
(window,function(t){
	...
	([function(i,e){i.exports=t},
		function(t,i,e){
			...
			findNearestOriginPoint: function(latlng, maxDistance = Infinity) {
				...
				this._trackPoints.forEach(p => {
					if (p.isOrigin) { // Alleen originele punten
						const pointLatLng = n.a.latLng(p.lat, p.lng);
						const sqDistance = latlng.distanceTo(pointLatLng); // Gebruik distanceTo ipv squared voor echte afstand
						if (sqDistance < minSqDistance && sqDistance <= maxDistance) {
			...
			l=n.a.Class.extend({ // Dit is de Draw class
				trackPointOptions:{isDraw:!1,useCanvas:!0,stroke:!1,color:"#ef0300",fill:!0,fillColor:"#ef0300",opacity:.3,radius:4},
						trackLineOptions:{/*isDraw:!1, --> Verwijderd */ stroke:!0,color:"#1C54E2",weight:2,fill:!1,fillColor:"#000",opacity:.3}, // Standaard stroke=true
